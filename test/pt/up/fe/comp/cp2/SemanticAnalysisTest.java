...
public class SemanticAnalysisTest {
    ...
    public  void thisAsCommonExpression(){
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp2/semanticanalysis/thisAsCommonExpression.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }
    ...
    public  void varLookupField(){
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp2/semanticanalysis/VarLookupField.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }
    ...
    public  void simpleTest(){
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp2/semanticanalysis/SimpleTest.jmm"));
        TestUtils.noErrors(result);
    }

    @Test
    public  void callMethodNotExists(){
        var result = TestUtils.analyse(SpecsIo.getResource("pt/up/fe/comp/cp2/semanticanalysis/CallMethodNotExists.jmm"));
        TestUtils.mustFail(result);
        System.out.println(result.getReports());
    }
}
